      ...
      private
        ...
        def request_for_component(controller_name, options)
          if options.is_a? Hash
            ...
            request_env['action_controller.request.symbolized_path_parameters'] = request_params
            request_env['action_controller.request.parameters'] = request_params.with_indifferent_access
            request_env['action_controller.request.path_parameters'] = request_params.slice(:controller, :action).with_indifferent_access
            request_env['action_controller.request.query_parameters'] = request_params.except(:controller, :action).with_indifferent_access
            ActionController::Request.new(request_env)
          else
            request
          end
        end
